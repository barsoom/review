defmodule Review.RepoTest do
  ...
  test "insert_or_update_author: can persist and find an author by email or username" do
    author = Repo.insert_or_update_author(%{ email: "foo@example.com", username: "foo", name: "Foo" })
    ...
    author2 = Repo.insert_or_update_author(%{ email: "foo@example.com", username: "foo", name: "Foo" })
