...
update settings msg =
    case msg of
        ...
        UpdateShowCommentsYouWrote value ->
            { settings | showCommentsYouWrote = value }

        UpdateShowResolvedComments value ->
            { settings | showResolvedComments = value }

        UpdateShowCommentsOnOthers value ->
            { settings | showCommentsOnOthers = value }

        ToggleShowAllReviewedCommits ->
            { settings | showAllReviewedCommits = not settings.showAllReviewedCommits }
